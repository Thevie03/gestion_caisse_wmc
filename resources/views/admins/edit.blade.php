    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admins.update', $admin) }}" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control @error('telephone') is-invalid @enderror"
                                    id="telephone" name="telephone" value="{{ old('telephone', $admin->telephone) }}"
                                ...
                                <select class="form-select @error('boutique_id') is-invalid @enderror" id="boutique_id"
                                    ...
                                    @foreach ($boutiques as $boutique)
                                        <option value="{{ $boutique->id }}"
                                            {{ old('boutique_id', $admin->boutique_id) == $boutique->id ? 'selected' : '' }}>
                                            {{ $boutique->nom }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text">
                                    <small class="text-muted">Décochez pour désactiver le compte de l'administrateur</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-light border">
                            <div class="row">
                                <div class="col-md-6">
                                    <strong>Créé le :</strong> {{ $admin->created_at->format('d/m/Y à H:i') }}
                                </div>
                                <div class="col-md-6">
                                    <strong>Dernière modification :</strong>
                                    {{ $admin->updated_at->format('d/m/Y à H:i') }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admins.show', $admin) }}" class="btn btn-outline-info">
                                <i class="fas fa-eye me-2"></i>
                                Voir le profil
                            </a>
                            <div>
                                <a href="{{ route('admins.index') }}" class="btn btn-outline-secondary me-2">
